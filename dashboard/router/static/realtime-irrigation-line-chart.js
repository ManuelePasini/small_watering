                ...
                x: {
                    ...
                    realtime: {
                        ...
                        onRefresh: async function (chart) {
                            ...
                            $("#rmse").text(Math.round(IrrigationData["r"] + parseInt($("#rmse").text) * 100) / 100)
                            console.log($("#rmse").text)
                            console.log((Math.round(IrrigationData["r"] + parseInt($("#rmse").text) * 100) / 100))
